...
const ParticipantFields = ({
  index,
  register,
  form: { errors, getValues, setError },
  participantsLimit,
}: {
  index: number;
  register: UseFormRegister<any>;
  form: { errors: any; getValues: any; setError: any };
  ...
  const fieldName = index == 0 ? "Member 1" : `Member ${index + 1}`;
      ...
      <div className={styles.member_input}>
        ...
        <input
          ...
          className={
            errors.participants &&
            errors.participants[index] &&
            errors.participants[index].grade?.message &&
            styles.error_field
          }
