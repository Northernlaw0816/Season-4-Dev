...
const NavBar = () => {
    ...
    const Title = () => {return (<div className={styles.title}>
        Certificates Hub
    </div>)}
    ...
    const FullNav = () => {return(<>
        <div className={styles.navbar_layout}>
            <nav className={styles.navbar}>
                <Link href="https://nutopia.in/"><a aria-label="NuTopia Home" role="link" className={`${styles.nav_button} ${styles.home_button_prt}`}>
                    <HomeButton/>
    ...
    const MobNav = () => {return(<>
        <div className={styles.navbar_layout}>
            <nav className={styles.navbar_mobile}>
                <Link href="https://nutopia.in/"><a aria-label="Nu Topia Home" role="link" className={`${styles.nav_button} ${styles.home_button_prt}`}>
                    <HomeButton/>
                    <span className={styles.logo_text}>Topia</span>
                </a></Link>
                <Title/>
