        ...
        <nav className={styles.navbar}>
            <Link href="/"><a className={`${styles.nav_button} ${styles.home_button_prt}`} aria-label="NuTopia Homepage">
                ...
                <g id="Group 1">
                    ...
                    <path d="M0 57L19 0H33L14 57H0Z" fill="#004799" stroke="black" strokeWidth="2" mask="url(#path-1-inside-1_0_1)"/>
                    </g>
            ...
            <span className={styles.spacer}>Season 1</span>
            <div className={styles.nav_button} aria-label="Menu">
