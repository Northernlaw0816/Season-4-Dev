			...
			<body class="body_container">
				<div class="email_body">
					...
					<div class="email_content">
						...
						<p>For queries regarding this registration, please contact us at <a href="mailto:info@nutopia.in"
								style="color: #00cc22;">info@nutopia.in</a>.</p>
				...
				<div class="email_footer">
					<table class="links">
						<tr>
							<td class="link">
								<a href="https://nutopia.in" class="icon_link"><img
										style="background: #00cc22; border-radius: 4px;"
							...
							<td class="link">
								<a href="https://www.facebook.com/NuTopia-106903048559461/?ref=page_internal"
									class="icon_link filter_2"><img
							...
							<td class="link">
								<a href="https://www.youtube.com/channel/UC6gMtIVvbPDfVsR4e1Knx9A"
									class="icon_link filter_2"><img
					...
					<p class="copyright">&copy; <a href="https://yuvabharathi.in" style="color: #00cc22">Yuvabharathi Public School</a> 2024. All Rights Reserved.</p>
				</div>
			</body>`