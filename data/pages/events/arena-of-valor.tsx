...
const ArenaOfValor = {
  ...
  details: {
    ...
    date: [
      `${Main.dates.day1}, 10:00 a.m. - 7:00 p.m.`,
      `${Main.dates.day2}, 9:30 a.m. - 12:30 p.m.`
    ],

    dateAndTime: `${Main.dates.day1}, 10:00 a.m. - 7:00 p.m. | ${Main.dates.day2}, 9:30 a.m. - 12:30 p.m.`,
        ...
        games: [
          {
            ...
            guidelines: [
              ...
              "Teams will be asked to choose their clubs prior to the event, both international and league clubs are allowed. In case of multiple teams choosing the same club, the allotments are made on a first come basis"
            ],
          },
        ],
