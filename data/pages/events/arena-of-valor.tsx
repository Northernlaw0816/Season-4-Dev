...
const ArenaOfValor = {
	...
	details: {
		...
		date: [`${Main.dates.day1}, 10:00 p.m. - 7:00 p.m.`, `${Main.dates.day2}, 9:30 a.m. - 12:30 p.m.`],
		...
		grades: "9 - 12",
		image: AoV,
		accent: "linear-gradient(to bottom, hsl(180, 100%, 20%) 20%, hsl(0, 0%, 0%) 20%)",
	},
	...
	headings: {
		...
		commonGuidelines: [
			...
			"Teams that attempt to use players who are not registered in their team will be disqualified.",
			"Account sharing will be met with disqualification.",
			[
				"Abusing in-game glitches that give a team an unfair advantage is not permitted.",
				" Teams caught doing so may be disqualified.",
			],
			[
				"Depending on the settings for each individual tournament, more rules may apply for every match, such as banned items",
				" If any special rules apply, then they may be found in the tournament’s registration article.",
			],
			"If two teams fail to schedule their match during the given time limit, one or both teams may be disqualified.",
			[
				"During an on-going tournament, players are not allowed to change their in-game name.",
		...
		platforms: [
				...
				games: [
					{
						...
						guidelines: [
							...
							[
								"Players are required to compete under their registered account names.",
								" altering in-game identities post-registration is strictly prohibited.",
							],
							...
							[
								"Participants are expected to ensure a reliable network connection.",
								"connectivity issues will not be accommodated.",
							],
					...
					},
					{
						...
						guidelines: [
							...
							[
								"Discord and Whatsapp are the means of communication.",
								" We require your gaming device to have a functional camera and microphone.",
								" We may also require screen sharing at times.",
							],
							"Three rounds will be conducted over the course of 2 days.",
							[
								"Round 1 : Parkour",
								"A single parkour course will be the challenge for all teams.",
								"A team will be given only one run through where both of the members must complete the course.",
							],
							[
								"Round 2 : Build",
								"Each team will be allotted a 4x4 chunk with signs indicating the teams and school name.",
								"Creative mode will be set for everyone. Teams will be given 1.5 hours to build based on the given topic.",
								"If any participant is found to be griefing - such as building inappropriate structures or sabotaging other teams, or using mods/plugins - the team will be disqualified from the round.",
							],
							[
								"Round 3 : Battle Royale",
								"Survival mode with normal difficulty will be set for everyone.",
								"A total of 3 matches will be conducted where the teams must gather resources and be the last team standing while the zone shrinks periodically.",
								"Loot Boxes will be present throughout the map.",
								"Points are earned through placements and eliminations.",
							],
						],
					},
				],

				eventCoordinators: EventCoordinators.filter((coordinator) => coordinator.event.includes("Arena of Valor - PC")),
			},
				...
				games: [
					{
						...
						bannedItems: [],
						guidelines: [
							"Matches will be played in teams of two with each match consisting of two 6 minute halves.",
							...
							[
								...
								"Players are not allowed to handle the console outside the tournament and change any settings.",
								"Strict action will be taken.",
							],
							"Teams are discouraged from sharing controllers with other teams to avoid any damages",
							[
								"Teams will be asked to choose their clubs prior to the event, both international and league clubs are allowed.",
								"In case of multiple teams choosing the same club, the allotments are made on a first come basis",
							],
						],
					},
				],
...

			{
				...
				description: "Arena of Valor - Mobile",
				...
				games: [
					...
					},
					{
						...
						guidelines: [
							...
							[
								"Customisations:",
								"Skins, Weapon Variants and Purchased Weapons that alter the default iron sights and/or ANY weapon properties (damage, speed, etc) are NOT allowed",
								"Iron sight changes are NOT allowed.",
								"Cosmetic weapons are allowed, but MUST use default weapon iron sights.",
							],
