...
const LogAndBlog = {
	...
	details: {
		shortDescription:
			"Ignite your inner writer! Log and Blog is an event which lets you unleash your creative writing skills. Log in, research, review and pen your refreshing thoughts.",
	...
	headings: {
		...
		rules: [
			...
			[
				"Participants will be given a time of 2.5 hours to complete their blogs.",
			...
			[
				"Topics once assigned cannot be changed since topics given are completely randomized.",
				"Participants must refrain from exceeding the time limit.",
			],
			...
			[
				"Round 2:",
				"Participants will be given statements by famous tech-personalities and would have to strictly oppose the given statement and provide credible arguments against the statement.",
			],
		],

		assessment: ["Creativity", "Factual Accuracy", "Grammatical Accuracy", "Organisation"],
