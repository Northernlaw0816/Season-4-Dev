...
const Otakuiz = {
    ...
    headings: {
        ...
        rules: [
            ...
            "The event consists of a preliminary round followed by 2 main rounds, namely : semi finals (jeopardy) and finals (buzzer round). The event will go on for 2 days.",
