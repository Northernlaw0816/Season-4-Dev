const date = new Date('July 17 2023 21:00:00 GMT+0530')
...
const Main = {
    ...
    dates: {
        day1: new Date(2024, 6, 19).toDateString().split(" ").slice(1).join(" "),
        day2: new Date(2023, 6, 20).toDateString().split(" ").slice(1).join(" ")
    },
