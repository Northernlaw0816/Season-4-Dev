const date = new Date('July 20 2024 21:00:00 GMT+0530')
...
const Main = {
    ...
    dates: {
        day1: new Date(2024, 7, 25).toDateString().split(" ").slice(1).join(" "),
        day2: new Date(2023, 7, 26).toDateString().split(" ").slice(1).join(" ")
    },
