...
const Main = {
    ...
    updateMessage: date.getTime() <= new Date().getTime() ? "IMPORTANT INFORMATION: LAST DATE FOR REGISTRATION - FEBRUARY 6 2022, 3 PM" : "IMPORTANT INFORMATION: REGISTRATIONS ARE CLOSED"
}
