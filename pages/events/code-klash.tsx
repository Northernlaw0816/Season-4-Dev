		...
		<>
			...
			<Layout skipTo="#tagline" overrideClasses={`${styles.main} ${styles.ck} ${eventStyles.main}`}>
				...
				<div className={styles.content}>
					...
					<EventsRegisterButton pathname="https://docs.google.com/forms/d/e/1FAIpQLSctqydrj102vBaYE1HhBOFbCV0Zh4cUM-mR8CbL8S--06pRCg/viewform?usp=sf_link" text={`Register for ${CodeKlashData.title}`} />
					</div>	
				</div>
			</Layout>
		</>
