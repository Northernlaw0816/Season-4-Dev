...
const Designscape: NextPage= () => {
    ...
    useEffect(() => {
        ...
        anime.set([".logo_container .hexagon", ".logo_container .box", ".logo_container .circle"], {
            translateX: "50%",
            translateY: "50%",
            opacity: 0
        })
